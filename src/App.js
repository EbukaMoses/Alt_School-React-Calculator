  ...
  return (
    <div className="container">
      <div className="wrapper">
        <div className="screen">{input !== "" || input === "0" ? <NumericFormat value={input} displayType={'text'} thousandSepartor={true} /> : <NumericFormat value={preState} displayType={'text'} thousandSepartor={true} />}</div>
